...
// we don't care about overtime here - just compare points!
...
function getWinnersByYear(data, getYearsCB, getWinnersCB) {
    const winncers = getWinnersCB(data, getFinals);
    const years = getYearsCB(data, getFinals);
    return winncers.map((item, index) => `In ${years[index]}, ${item} won the world cup!`);
};
